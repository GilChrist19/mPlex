...
###############################################################################
# 20200903
#  This is taken directly from the base simulation exploration, currently in the 
#  "Main" directory, labeled "YogitaData". It is here for completeness, so that 
#  I can ship this whole directory and it will work. There should be no changes 
#  to this file.
#
# Description from the original file
