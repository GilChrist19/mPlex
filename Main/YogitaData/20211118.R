...
# 20211118
#  Update to 20210812
#  Adding larval sampling
#  Checked pupal sampling, didn't give me any problems
#
###############################################################################
...
# pupae/male/female get sampled daily
sampDay[ ,c(2,3,4,5)] <- 1
...
sampCov <- matrix(data = c(0,0.10,0.10,0.10,0.10)/7, nrow = numPatch, ncol = 5, byrow = TRUE)
