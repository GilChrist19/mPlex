...
# 2021072
#  Update to 20210719
#  The smallest population was too small, so only test with 18 and 24 total 
#  population now. Also doing 1000 just to make sure everything works.
#  Generate several repetitions - 15.
#  Sample every day, but at the same rate. So, instead of 10% sample size once 
#  per week, do 10%/7 every day.
#
###############################################################################
...
sampCov <- matrix(data = c(0,0.10,0,0,0.10)/7, nrow = numPatch, ncol = 5, byrow = TRUE)
