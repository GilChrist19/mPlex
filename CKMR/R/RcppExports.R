...
#' }
#'
run_mPlex <- function(seed_, numReps_, numThreads_, networkParameters_, reproductionReference_, patchReleases_, migrationMale_, migrationFemale_, migrationBatch_, samplingParameters_, outputDirectory_, verbose_) {
    invisible(.Call('_CKMR_run_mPlex', PACKAGE = 'CKMR', seed_, numReps_, numThreads_, networkParameters_, reproductionReference_, patchReleases_, migrationMale_, migrationFemale_, migrationBatch_, samplingParameters_, outputDirectory_, verbose_))
}
...
calcCos <- function(latLongs, r = 6378137) {
    .Call('_CKMR_calcCos', PACKAGE = 'CKMR', latLongs, r)
}
...
calcHaversine <- function(latLongs, r = 6378137) {
    .Call('_CKMR_calcHaversine', PACKAGE = 'CKMR', latLongs, r)
}
...
calcVinSph <- function(latLongs, r = 6378137) {
    .Call('_CKMR_calcVinSph', PACKAGE = 'CKMR', latLongs, r)
}
...
calcVinEll <- function(latLongs, a = 6378137, b = 6356752.3142, f = 1.0/298.257223563, eps = 1e-12, iter = 100) {
    .Call('_CKMR_calcVinEll', PACKAGE = 'CKMR', latLongs, a, b, f, eps, iter)
}
...
calcLognormalKernel <- function(distMat, meanlog, sdlog) {
    .Call('_CKMR_calcLognormalKernel', PACKAGE = 'CKMR', distMat, meanlog, sdlog)
}
...
calcGammaKernel <- function(distMat, shape, rate) {
    .Call('_CKMR_calcGammaKernel', PACKAGE = 'CKMR', distMat, shape, rate)
}
...
calcExpKernel <- function(distMat, rate) {
    .Call('_CKMR_calcExpKernel', PACKAGE = 'CKMR', distMat, rate)
}
...
simAgg <- function(readFiles_, writeFiles_, largeFile_, simTime_, genKey_) {
    invisible(.Call('_CKMR_simAgg', PACKAGE = 'CKMR', readFiles_, writeFiles_, largeFile_, simTime_, genKey_))
}
